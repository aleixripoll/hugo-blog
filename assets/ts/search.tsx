...
class Search {
    ...
    private async searchKeywords(keywords: string[]) {
        ...
        for (const item of rawData) {
            ...
            const descriptionMatchAll = item.description.matchAll(regex);
            for (const match of Array.from(descriptionMatchAll)) {
            ...
            if (descriptionMatches.length > 0) result.description = Search.processMatches(result.description, descriptionMatches);
            ...
            result.matchCount = titleMatches.length + descriptionMatches.length + contentMatches.length;
        ...
        return <article>
            <a href={item.permalink}>
                <div class="article-details">
                    ...
                    <h3 class="article-subtitle" dangerouslySetInnerHTML={{ __html: item.description}}></h3>
